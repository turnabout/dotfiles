...
s0_left_window_key = <Control>KP_Multiply
s0_right_window_key = <Control>Prior
s0_up_window_key = <Control>Home
s0_down_window_key = <Control>KP_Divide
...
s0_left_maximize = <Shift><Control>h
s0_right_maximize = <Shift><Control>l
...
[core]
s0_active_plugins = core;composite;opengl;snap;compiztoolbox;commands;imgpng;vpswitch;resize;move;mousepoll;copytex;place;regex;wall;grid;unitymtgrabhandles;animation;session;fade;workarounds;expo;scale;ezoom;unityshell;
...
s0_minimize_window_key = <Shift><Control>j
s0_minimize_window_button = Disabled
s0_maximize_window_key = <Shift><Control>k
